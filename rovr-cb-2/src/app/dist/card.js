(function(require$$0, react) {
  ...
  function useAssociationsInternal(config, options = DEFAULT_OPTIONS) {
    ...
    const [state, dispatch] = require$$0.useReducer(associationsReducer, require$$0.useMemo(() => createInitialState(pageSize), [pageSize]));
  ...
  hubspot.extend(({ context }) => /* @__PURE__ */ React.createElement(Extension, { context }));
  const Extension = ({ context }) => {
    ...
    if (contactsError) return /* @__PURE__ */ React.createElement(ErrorState, { title: "Error" }, /* @__PURE__ */ React.createElement(Text, null, contactsError.message));
    ...
    if (clinicsLoading) return /* @__PURE__ */ React.createElement(LoadingSpinner, { label: "Loading messages..." });
    if (clinicsError) return /* @__PURE__ */ React.createElement(ErrorState, { title: "Error" }, /* @__PURE__ */ React.createElement(Text, null, clinicsError.message));
    const clinics = (clinicResults == null ? void 0 : clinicResults.map((r) => r.properties)) ?? [];
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Heading, null, contactProperties.firstname, " ", contactProperties.lastname, " (", contactProperties.email, ")"), /* @__PURE__ */ React.createElement(Spacer, { size: "medium" }), /* @__PURE__ */ React.createElement(Flex, null, clinics.map((c) => {
